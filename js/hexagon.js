...
for (i = 0; i < numberOfSides; i++) {
    context.fillText(testCategories[i], xCenter - 30 + 1.7 * circumradius * Math.cos((i + 1) * 2 * Math.PI / numberOfSides + Math.PI / numberOfSides), yCenter + 5 - 1.15 * circumradius * Math.sin((i + 1) * 2 * Math.PI / numberOfSides + Math.PI / numberOfSides))
}
